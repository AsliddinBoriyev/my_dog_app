...
class NetworkService {
  ...
  static const API_FAVOURIES = "/v1/favourites";
  static const API_FAVOURITES_ID = "/v1/favourites/{favourite_id}";
  static const API_DELETE_FAVOURITE= "/v1/favourites/{favourite_id}";
  ...
  static Map<String, String> paramsFavoritesList({int limit = 10, int page = 0, String? subId}) {
    Map<String, String> map = {
      'limit': limit.toString(),
      'page': page.toString()
    };
  ...
  static Map<String, String>paramsSpecificFavorite({String favouriteID="1ud"}) {
    Map<String, String> map = {
      "favourite_id": favouriteID,
    };
    return map;
  }
  static Map<String, String>paramsDeleteFavourite({String favouriteID="1ud"}) {
    Map<String, String> map = {
      "favourite_id": favouriteID,
    };
    return map;
